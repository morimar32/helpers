...
type Outboxer interface {
	...
	Publish(ctx context.Context, tx *sql.Tx, topic string, eventName string, payload interface{}) error
}
...
func (o *Outbox) Publish(ctx context.Context, tx *sql.Tx, topic string, eventName string, payload interface{}) error {
